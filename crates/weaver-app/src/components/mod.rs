...
#[component]
pub fn BskyIcon(props: IconProps) -> Element {
    rsx! {
        svg {
            class: "{props.class}",
            style: props.style,
...
#[component]
pub fn TangledIcon(props: IconProps) -> Element {
    rsx! {
        svg {
            class: "{props.class}",
            style: props.style,
            height: props.height.map(|height| height.to_string()),
            width: props.width.map(|width| width.to_string()),
            view_box: "0 0 24.122343 23.274094",
            path {
...
#[used]
static _IOSK_LIGHT: Asset = asset!(
...
#[used]
static _IOSK_LIGHT_ITAL: Asset = asset!(
...
#[used]
static _IOSK_ITAL_BOLD: Asset = asset!(
