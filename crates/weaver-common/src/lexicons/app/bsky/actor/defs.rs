...
pub struct StatusViewData {
    ...
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub embed: core::option::Option<atrium_api::types::Union<StatusViewEmbedRefs>>,
...
pub type StatusView = atrium_api::types::Object<StatusViewData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
...
pub type VerificationPrefs = atrium_api::types::Object<VerificationPrefsData>;
...
pub type VerificationState = atrium_api::types::Object<VerificationStateData>;
