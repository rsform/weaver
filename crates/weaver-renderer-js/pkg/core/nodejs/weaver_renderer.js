...
exports.JsMathResult = JsMathResult;
...
exports.JsResolvedContent = JsResolvedContent;
 ...
 */
function create_resolved_content() {
    const ret = wasm.create_resolved_content();
    return JsResolvedContent.__wrap(ret);
}
exports.create_resolved_content = create_resolved_content;
 ...
 * @returns {string}
 */
function render_faceted_text(text, facets_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.render_faceted_text = render_faceted_text;
 ...
 * @returns {string}
 */
function render_markdown(markdown, resolved_content) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 */
function render_math(latex, display_mode) {
...
exports.render_math = render_math;
 ...
 * @returns {string}
 */
function render_record(at_uri, record_json, fallback_author, resolved_content) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.render_record = render_record;
...
const wasmPath = `${__dirname}/weaver_renderer_bg.wasm`;
